...
namespace Pv.Unity
{
    ...
    public class PorcupineManager
    {
        ...
        public static PorcupineManager FromKeywordPaths(string accessKey, IEnumerable<string> keywordPaths, Action<int> wakeWordCallback,
                                                    string modelPath = null, IEnumerable<float> sensitivities = null, Action<PorcupineException> processErrorCallback = null, Action<int> processCallback = null)
        {
        ...
        public static PorcupineManager FromBuiltInKeywords(string accessKey, List<Porcupine.BuiltInKeyword> builtInKeywords, Action<int> handleWakeWordDetected, Action<PorcupineException> onPorcupineError)
        {
